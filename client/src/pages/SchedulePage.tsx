    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        {!anyCalendarConnected && authStatus?.configured && (
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        {!anyCalendarConnected && !authStatus?.configured && (
          <div className="bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="text-xl">📅</span>
              <div>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-4">
            ...
            <div className="space-y-2">
              {needsAttention.map((t) => (
                <div key={t.id} className="flex items-center justify-between gap-2 bg-white dark:bg-gray-900 rounded-lg px-3 py-2 min-w-0">
                  <p className="text-sm text-slate-700 dark:text-gray-200 truncate min-w-0">{t.title}</p>
                  <button
        ...
        {/* Dev tools */}
        <div className="pt-4 border-t border-slate-200 dark:border-gray-800 flex flex-wrap items-center justify-between gap-2">
